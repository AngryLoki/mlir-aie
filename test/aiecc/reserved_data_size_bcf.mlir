...
// bank-aware placement chosen to satisfy reserved_data_size: three 4 KB
// buffers, tightly packed from the bottom (rather than spread one per bank)
// because reserved_data_size cannot be met while spreading. aie-translate
// --aie-generate-bcf needs no chess toolchain or hardware -- it is a pure
// MLIR-to-text translation.
...
// CHECK: _symbol a 0x70400 4096
// CHECK: _reserved DMb 0x70400 4096
// CHECK: _symbol b 0x71400 4096
// CHECK: _reserved DMb 0x71400 4096
// CHECK: _symbol c 0x72400 4096
// CHECK: _reserved DMb 0x72400 4096
