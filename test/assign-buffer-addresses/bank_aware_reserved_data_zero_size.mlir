...
// region it happens to sit inside: largestFreeRun (the primitive this pass's
// reserved_data_size acceptance test shares with AIETargetLdScript) has to
// see the space above the stack as one 64512-byte run, not two runs split at
// the zero-sized buffer's address.
